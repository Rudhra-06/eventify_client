    ...
    <div className="min-h-screen flex items-center justify-center bg-beige-50">
      <div className="bg-black/80 p-8 rounded-xl shadow-lg w-96 backdrop-blur-md">
        ...
        <input
          name="name"
          placeholder="Name"
          className="w-full mb-3 p-2 rounded border border-orange-200 bg-beige-100 text-black placeholder-black/60 focus:outline-none focus:ring-2 focus:ring-orange-200"
          value={form.name}
        ...
        <select
          name="role"
          className="w-full mb-4 p-2 rounded border border-orange-200 bg-beige-100 text-black focus:outline-none focus:ring-2 focus:ring-orange-200"
          value={form.role}
          onChange={handleChange}
        >
